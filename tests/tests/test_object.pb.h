...
class test_object PROTOBUF_FINAL :
 ...
 public:
  ...
  inline test_object* New() const final {
    return CreateMaybeMessage<test_object>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_test_5fobject_2eproto.file_level_metadata[kIndexInFileMessages];
  }
